...
Static site, no build step. Enable GitHub Pages on this repo (root or `/docs`, depending on where it's pushed) and it's live. Each of the 8 linked projects is its own separate repo with GitHub Pages enabled the same way.
